...
User: Using the numbers {numbers}, create an equation that equals {target}. You can use basic arithmetic operations (+, -, *, /) and each number can only be used once. Show your work in <think> </think> tags. 
And your final answer will be extracted automatically by the \\boxed{{}} tag, for example \\boxed{{(1 + 2) / 3}}.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='~/data/countdown_nochat_boxed')
