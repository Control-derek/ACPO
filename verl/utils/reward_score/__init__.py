...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source == "open_reasoner_zero" or data_source == "math500" or data_source == "aime2024" or data_source == "gpqa" or data_source == "minerva" or data_source == "olympiad_minerva" or data_source == "amc" or data_source == "aime2025":
    ...
    elif data_source == "countdown_boxed":
        from . import countdown_boxed
        res = countdown_boxed.compute_score(solution_str, ground_truth, format_score=0.)
    elif data_source.startswith("kk_logic"):
        from . import kk
    ...
    elif data_source == 'syn_logic':
        from . import syn_logic
        res = syn_logic.compute_score(solution_str, ground_truth, extra_info)
    else:
